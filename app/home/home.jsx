<>
    ...
    >
        ...
        >
            ...
            <div className="w-[368px] h-[59px] text-center text-white text-base font-normal font-primary leading-5 tracking-[0.03em]">
                Dive into the ultimate party scene discover lit club nights, epic
                events, and non-stop vibes all in one place!
            </div>
    ...
    >
        ...
        <div
            className="w-[273px] h-[35px] py-1.5 left-[16px] top-[108px] absolute flex-col justify-center items-start gap-2.5 inline-flex"
