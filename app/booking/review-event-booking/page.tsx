...
export default function ReviewEventBookingPage() {
    ...
    return (
        <div className="w-full min-h-screen relative bg-[#021313]">
            ...
            <div className="absolute top-[10rem] left-0 right-0 bg-[#021313] overflow-y-auto scrollbar-hide pb-32 h-[calc(100vh-10rem)] mb-16">
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50">
                <div className="w-full h-20 bg-gradient-to-t from-black to-transparent">
                    <div className="absolute bottom-0 left-0 right-0 h-[3.75rem] overflow-hidden px-4 py-3">
                        <button
                            onClick={handleContinue}
                            className="w-full h-full rounded-[1.875rem] bg-gradient-to-r from-[#14FFEC] to-[#0A898B] flex items-center justify-center"
                        >
                            <span className="text-[#021313] text-[1rem] font-['Manrope'] font-bold whitespace-nowrap">
                                Confirm Booking
                            </span>
                        </button>
                    </div>
