        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0d7377] to-[#222831] text-white">
            ...
            <div className="px-6 py-6 space-y-6">
                ...
                <div className="space-y-4">
                    <div>
                        <h2 className="text-white font-bold text-2xl mb-2">DABO</h2>
                        <div className="flex items-center gap-2 mb-2">
                            <MapPin size={16} className="text-teal-400" />
                            <p className="text-white/80 text-sm">6, New Manish Nagar, Somalwada, Nagpur</p>
                        </div>
                        <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="bg-[#222831] rounded-lg p-4">
                        ...
                        <p className="text-teal-400 font-medium">Timeless Tuesdays Ft. DJ Xpensive</p>
                        <p className="text-white/70 text-sm mt-1">Live Now 🔴</p>
                    </div>
