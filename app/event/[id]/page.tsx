...
import { GenreTags } from '@/components/event/GenreTags';import { useToast } from '@/hooks/use-toast';
        ...
        <div className="min-h-screen bg-[#021313] text-white relative w-full max-w-[430px] mx-auto">
            ...
            >
                <div className="px-4 pt-8">
                    ...
                    {/* Organisers tab */}
                    <div className="flex justify-center" style={{ paddingTop: '20px', marginBottom: '67px' }}>
                        <div className="flex gap-[14px] self-stretch h-[86px] bg-[#0d1f1f] pl-[31px] pr-6 pt-[17px] pb-[17px] rounded-[20px] border border-solid" style={{ maxWidth: '398px' }}>
                            {/* first organiser */}
                            <div className="flex items-center gap-2">
                                <div className="w-[51px] h-[51px] rounded-full overflow-hidden">
                                    <img src="/placeholder1.png" alt="Team Events" className="w-full h-full object-cover" />
                                </div>
                                <span className="font-medium text-[16px] leading-[20px] text-white" style={{ fontFamily: 'Manrope', fontWeight: 500, letterSpacing: '0.0625em' }}>
                                    Team Events
                                </span>
                            ...
                            <div className="flex items-center gap-2 ml-[15px]">
                                <div className="w-[51px] h-[51px] rounded-full overflow-hidden">
                                    <img src="/placeholder2.png" alt="Ark Events" className="w-full h-full object-cover" />
                                </div>
                                <span className="font-medium text-[16px] leading-[20px] text-white" style={{ fontFamily: 'Manrope', fontWeight: 500, letterSpacing: '0.0625em' }}>
                                    Ark Events
                                </span>
