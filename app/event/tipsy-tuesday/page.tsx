                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-white/80 text-sm">9:00 PM - 2:00 AM</p>
                        </div>
                        <div className="flex items-center gap-2">
                            <Users size={16} className="text-teal-400" />
                            <p className="text-white/80 text-sm">200+ attending</p>
                        </div>
                    </div>
                    ...
                    <div className="glassmorphism rounded-xl p-4">
                        ...
                        <p className="text-white/80 text-sm leading-relaxed">
                            Join us for an unforgettable night of beats, vibes, and non-stop dancing!
                            DJ Alexxx will be spinning the hottest tracks mixing Techno and Bollywood beats.
                            Don't miss out on the party of the week!
                        </p>
                    </div>
